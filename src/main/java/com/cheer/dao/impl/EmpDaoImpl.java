...
public class EmpDaoImpl implements EmpDao
{
    ...
    public void  save(Emp emp)
    {
        ...
        String sql = "INSERT INTO emp666 VALUES( ?, ?, ?, ?, ?)";
    ...
    public void delete(Emp emp)
    {
        ...
        String sql = "DELETE FROM emp666 WHERE empno = ?";
    ...
    public void update(Emp emp)
    {
        ...
        String sql = "update emp666 set ename = ? where empno = ? ";
    ...
    public List<Emp> getAll()
    {
        ...
        String sql = "SELECT * FROM emp666 ORDER BY empno";
